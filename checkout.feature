            ...
            Quando eu digitar o nome "Kauã", sobrenome "Gustavo", País "BR", Endereço "Flores", Cidade "Cerquilho", CEP "444", Telefone "898", Email "kaua@gustavoEBAC.com.br"
            E clicar em "FINALIZAR COMPRA"
            Então a compra deve ser finalizada

            Cenário: Formato Inválido
            Quando eu digitar o nome "Kauã", sobrenome "Gustavo", País "BR", Endereço "Flores", Cidade "Cerquilho", CEP "444", Telefone "898", Email "kaua@gustavo.com.br"
            E clicar em "FINALIZAR COMPRA"
            ...
            | nome | sobrenome | pais | endereco | cidade    | cep | telefone | email                   | finalizar/mensagem             |
